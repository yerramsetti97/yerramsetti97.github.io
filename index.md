...
[cite_start]I am a **Backend Software Engineer with over 5 years of industry experience**[cite: 5, 17]. [cite_start]My engineering philosophy centers on the idea that backend systems should be "invisible"—seamless, resilient, and highly available even under the heaviest loads[cite: 7].
...
[cite_start]*Aug 2025 – Present* [cite: 15, 18]
...
[cite_start]*Sep 2021 – Jul 2023* [cite: 23, 25]

* [cite_start]Engineered RESTful services optimized for high-integrity transactional data[cite: 26].
* [cite_start]Improved performance by 15% through strategic code-splitting and backend optimization[cite: 27, 28].
...
[cite_start]*Dec 2019 – Dec 2020* [cite: 37, 38, 39, 40]

* [cite_start]Resolved critical system incidents across Unix and Windows to improve service reliability[cite: 41].
* [cite_start]Programmed Python automation scripts for anomaly detection and real-time alerts[cite: 42].
* [cite_start]Managed 200+ enterprise user accounts while ensuring strict data integrity[cite: 43].
...
* **Bachelor of Technology, Computer Science** | [cite_start]Geethanjali College of Engineering [cite: 14]
